...
public class BoPhan extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtQuanLyPhongBan.setBackground(new Color(0, 153, 153));
        ...
        tbQuanLyPhongBan.setModel(new DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        txtQuanLyBoPhan.setBackground(new Color(0, 153, 153));
        ...
        tbQuanLyBoPhan.setModel(new DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
...
//            cbMaBP_PB.setSelectedItem(tbQuanLyPhongBan.getValueAt(row, 1).toString());
    ...
    private void cbMaPB_PBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbMaPB_PBActionPerformed
        ...
        if(maPB.equals("")){
            ...
            PhongBan pb = pbDAO.getPhongBanByMaPB(maPB);
    ...
    private JComboBox<String> cbMaBP_BP;
    private JComboBox<String> cbMaBP_PB;
    private JComboBox<String> cbMaPB_PB;
