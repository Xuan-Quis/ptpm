...
//        btnReset_TDBL.setForeground(Color.white);
    ...
    private void initComponents() {
        ...
        cbThang_BTL = new JComboBox<>();
        cbNam_BTL = new JComboBox<>();
        ...
        cbMaLuongMoi = new JComboBox<>();

        jTabbedPane1.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N

        txtThongTinBangLuong.setBackground(new Color(0, 153, 153));
        ...
        tbl_TTBL.setModel(new DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        txtBangTinhLuong.setBackground(new Color(0, 153, 153));
        ...
        tbl_BTL.setModel(new DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        cbThang_BTL.setModel(new DefaultComboBoxModel<>(new String[] { "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12" }));
        ...
        cbNam_BTL.setModel(new DefaultComboBoxModel<>(new String[] { "2024", "2023", "2022", "2021", "2020", "2019", "2018", "2017", "2016" }));
        ...
        txtThayDoiBangLuong.setBackground(new Color(0, 153, 153));
        ...
        tbl_TDBL.setModel(new DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
...
//        Phantichthietkehethong_nhom4.resetForm(jPBangLuong);
    ...
    private JComboBox<String> cbMaLuong;
    private JComboBox<String> cbMaLuongMoi;
    private JComboBox<String> cbMaNV;
    private JComboBox<String> cbNam_BTL;
    private JComboBox<String> cbThang_BTL;
