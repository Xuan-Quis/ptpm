...
//        panelGradient1.addColor(new ModelColor(color1,0f),new ModelColor(color3, 1f));
    ...
    public void loadDataToTableThuViec(List<HoSoThuViec> nvtvList){
    ...
    private void initComponents() {
        ...
        tblQuanLyNhanVienThuViec = new JTable();
        ...
        tblQuanLyNhanVienBiThoiViec = new JTable();

        tfQuanLyBaoHiem3.setBackground(new Color(0, 153, 153));
        ...
        txtThongTinChiTiet.setBackground(new Color(0, 153, 153));
        ...
        tblThongTinChiTiet.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        tblThongTinChiTiet.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        ...
        txtQuanLyBaoHiem.setBackground(new Color(0, 153, 153));
        ...
        tblQuanLyBaoHiem.setModel(new DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        txtQuanLyNhanVienThuViec.setBackground(new Color(0, 153, 153));
        ...
        txtQuanLyNhanVienBiThoiViec.setBackground(new Color(0, 153, 153));
        ...
        tblQuanLyNhanVienThuViec.setModel(new DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tblQuanLyNhanVienBiThoiViec.setModel(new DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
    ...
    private void btnDeleteNVTV1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteNVTV1ActionPerformed
        ...
        if(selectedRow != -1){
            ...
            HoSoThuViec nvtv = new HoSoThuViec(maNVTV, hoTen, ngaySinh, gioiTinh, CCCD, viTriThuViec, ngayBatDau, soThangTV, SDT, hocVan, maLuongTV, ghiChu);
    ...
    private JTable tblQuanLyBaoHiem;
    private JTable tblQuanLyNhanVienBiThoiViec;
    private JTable tblQuanLyNhanVienThuViec;
    private JTable tblThongTinChiTiet;
